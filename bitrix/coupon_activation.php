...
if (LANGUAGE_ID == 'ru')
{
	...
	$MESS['BUTTON_SUBMIT'] = '������������';
	$MESS['BUTTON_RESET'] = '��������';
	$MESS['ERROR_EMPTY_CONTENT'] = '������ �� ��������';
	$MESS['ERROR_INVALID_CONTENT'] = '����� ������� �� ���������';
	$MESS['ERROR_NOT_ADMIN'] = '�� �� ��������� ���������������';
	$MESS['ERROR_INVALID_COUPON'] = '������������ ���� / ����� �� ���������';
	$MESS['ERROR_EMPTY_COUPON'] = '������������ ���� / ����� �� ������';
	$MESS['SUCCESS_RECOVER'] = "����������������� ����� �������������";
	$MESS['ERROR_NOT_WRITABLE'] = "���� �������� �� �������� �� ������";
	$MESS['ERROR_NOT_FOPEN'] = "�� ������� ������� ���� �� ������";
}
else
{
	$MESS['TITLE'] = 'Restore';
